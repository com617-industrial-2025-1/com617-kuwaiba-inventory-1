...
public class OverpassImportService {
   ...
   public OverpassImportResult importBoundingBox(OverpassBoundingBox bbox) throws Exception {
      ...
      OverpassImportResult result = new OverpassImportResult();
      result.setImportedBuildings(importedBuildings);
      result.setImportedRoads(importedRoads);
      result.setDeletedRawRows(0); // Not tracked in this implementation
      result.setDeletedDerivedRows(0); // Not tracked in this implementation
      return result;
